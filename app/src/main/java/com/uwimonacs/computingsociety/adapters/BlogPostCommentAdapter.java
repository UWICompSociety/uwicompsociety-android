...
public class BlogPostCommentAdapter extends RecyclerView.Adapter<BlogPostCommentAdapter.BlogPostCommentHolder> {
    private Context context;
    private List<Comment> comments;

    public BlogPostCommentAdapter(Context context, List<Comment> comments){
    ...
    @Override
    public BlogPostCommentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new BlogPostCommentHolder(LayoutInflater.from(context)
                .inflate(R.layout.comment_list_item, parent, false));
    }

    @Override
    public void onBindViewHolder(final BlogPostCommentHolder holder, int position) {
...
//        User user = User.getUser(comment.getUser_id());
    ...
    class BlogPostCommentHolder extends RecyclerView.ViewHolder{
        ImageView image, btnLike, btnDislike;
        TextView name, comment, date, numLikes, numDislikes;

        BlogPostCommentHolder(View itemView) {
            super(itemView);
